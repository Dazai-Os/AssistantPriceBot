...
async def help_start(message: types.Message):
    ...
    await message.answer("""Команда /view_product (Просмотр товаров) - это команда, которая показывает и присылает вместе с ссылками отслеживаемые ваши товары. Также можно удалить отслеживаемые товары""")
